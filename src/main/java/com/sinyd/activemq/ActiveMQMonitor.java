...
public class ActiveMQMonitor {
	private static final transient Logger LOG = LoggerFactory
			.getLogger(ActiveMQMonitor.class);
	...
	public Collection<ConnectionViewMBean> getConnections() throws Exception {
		...
		return getManagedObjects(
				queryResult.toArray(new ObjectName[queryResult.size()]),
	...
	public void purgeQueue(ActiveMQDestination destination) throws Exception {
		Set destinations = getManagedBroker().getQueueRegion().getDestinations(
				destination);
	 ...
	 * @return
	 */
	public Object newProxyInstance(ObjectName objectName, Class interfaceClass,
			boolean notificationBroadcaster) {
		return getManagementContext().newProxyInstance(objectName,
	...
	public void printSystemUsage(SystemUsage syUage) {
		...
		LOG.info("memeryUsage PercentUsage name ="
				+ memeryUsage.getPercentUsage());
		...
		LOG.info("storeUsage PercentUsage name ="
				+ storeUsage.getPercentUsage());
	...
	public void sendTopic(int i) throws JMSException {
		...
		MessageProducer productor = (MessageProducer) session
	...
	public void receiveTopic() throws JMSException {
		...
		MessageConsumer consumer = (MessageConsumer) session
